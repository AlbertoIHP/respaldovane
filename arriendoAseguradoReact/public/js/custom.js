...
jQuery(function($) {
  ...
  // get the value of the bottom of the #main element by adding the offset of that element plus its height, set it as a variable
    ...
    if (stop > mainbottom) {
        ...
        $(".navbar-fixed-top .navbar-brand .fijo").show(100);
        $(".navbar-fixed-top .navbar-brand .estatico").hide(100);
    } else {
        $('.navbar').removeClass('past-main');
        $(".navbar-fixed-top .navbar-brand .estatico").show(100);
        $(".navbar-fixed-top .navbar-brand .fijo").hide(100);
      }
    });
