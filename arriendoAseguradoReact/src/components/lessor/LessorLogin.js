...
class LessorLogin extends Component {
    toArrendatario(e) {
        e.preventDefault();
    ...
    render() {
        ...
        return (
            <MuiThemeProvider muiTheme={muiTheme}>
                <div style={{ ...styles.main, backgroundColor: "#323232" }}>
                    <div className="text-center" style={{ marginBottom: '20px' }}>
                        <img src={"/images/logo.png"} onClick={this.toHome} />
                    </div>
                    <Card style={styles.card}>
                        <h3 style={{ marginTop: '5px', fontSize: '24px' }}>Portal Arrendatarios</h3>
                    ...
                    <div className="text-center" style={{marginTop: '50px'}}>
                        <a href="" onClick={this.toArrendatario}> <i className="fa fa-user"></i> Acceder como Propietario</a>
                    </div>
                </div>
            </MuiThemeProvider>
        );
...
export default enhance(LessorLogin);